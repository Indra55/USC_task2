    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col transition-colors duration-200">
      <header className="bg-gradient-to-r from-indigo-600 to-indigo-800 dark:from-indigo-900 dark:to-purple-900 shadow-xl relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <p className="mt-2 text-indigo-100 text-sm max-w-3xl">
            Analyze historical air pollution data for schools in Los Angeles County. Select your school and attendance years to see detailed pollution analytics.
          </p>
        </div>
      </header>
